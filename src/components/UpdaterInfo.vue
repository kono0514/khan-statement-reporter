<template>
  ...
  >
    <div v-show="updateInProgress" class="absolute inset-0 flex justify-center items-center">
    ...
    <svg :class="{invisible: updateInProgress}" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" style="width: 24px;">
...
export default {
  ...
  computed: {
    tooltip() {
      return this.updateMessage === '' ? 'Update' : this.updateMessage;
    },
  },
  methods: {
    checkForUpdate() {
